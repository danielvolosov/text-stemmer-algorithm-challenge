...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("This output represents the top-20 most commonly occuring stems, as well as the frequency of each stem: " + commonTermCounter.getCommonWordFrequencyAndCount(stemsOfWords));
    }
}
